...
// start
function initStart() {
    var bt1 = document.querySelectorAll('#component-start')[0];
    ...
    var filter = document.querySelectorAll('#filter-goo-start feGaussianBlur')[0];
    ...
    bt1.addEventListener('click', function() {
        ...
        btTl.restart();
        window.setTimeout('window.location.href = \'/tuba_war/toQues1\'',2000);
    });
}