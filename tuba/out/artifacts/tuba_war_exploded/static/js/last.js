...
// last
function initLast() {
    var bt1 = document.querySelectorAll('#component-last')[0];
    ...
    var filter = document.querySelectorAll('#filter-goo-last feGaussianBlur')[0];
    ...
    bt1.addEventListener('click', function() {
        ...
        btTl.restart();
        window.setTimeout('window.location.href = \'/tuba_war/toEgg\'',1500);
    });
}